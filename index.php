...
if(
    ...
    if(!isset($errors)){
        ...
        if(empty($account)){
            ...
            $response = $bdd->prepare('INSERT INTO user(email, password, ip, date, name, firstname, activate_key) VALUES(?, ?, ?, ?, ?, ?, ?)');
            ...
            if($response->rowCount() > 0){
                ...
                http://wf3Project/comfirmation.php?id='.urlencode($id).'&key='.urlencode($key).'
